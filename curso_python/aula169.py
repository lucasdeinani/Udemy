...
caminho_inteiro = os.path.join(
    '\\home\\users', 'Desktop', 'curso', 'arquivo.txt'
)
print(caminho_inteiro)
caminho = os.path.join('Desktop', 'curso', 'arquivo.txt')
# print(caminho)
diretorio, arquivo = os.path.split(caminho)
# print(arquivo)
caminho_arquivo, extensao_arquivo = os.path.splitext(caminho_inteiro)
# print(caminho_arquivo, extensao_arquivo)
# print(os.path.exists(caminho))
# print(os.path.exists(
#     '\\Users\\Administrator\\Desktop\\Udemy\\Udemy\\curso_python'
# ))
print(os.path.abspath('.'))
print(os.path.basename(caminho_inteiro))
print(os.path.dirname(caminho_inteiro))
