...
# Importância de saber o sys.platform
# Setando o padrão para Mac
cmd = ['ping', '127.0.0.1', '-c', '4']
encoding = 'utf_8'
system = sys.platform

if system == 'win32':  # Significa que é Windows
    cmd = ['ping', '127.0.0.1']
    encoding = 'cp850'
...
print()
# print(proc.args)
# print(proc.stderr)  # Retornará none se capture_output não estiver True
# Retornará none se capture_output não estiver True
# print(proc.stdout.decode('cp852'))
# Se tiver com text=True não funciona mais o .decode()
print(proc.stdout)
